<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="articleumeditor.aspx.cs" Inherits="admin.web.aspx.articleumeditor" %>
...
<head>
    ...
    <script type="text/javascript">
        jQuery_general(function (e) {
            ...
            jQuery_general("#top").click(function () {
                jQuery_general('body,html').animate({
                    scrollTop: 0
                },
                    1000);
                return false;
    ...
    <link href="../js/lib/nprogress/0.2.0/nprogress.css" type="text/css" rel="stylesheet" />
    <script src='../js/lib/nprogress/0.2.0/nprogress.js' type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function save() {
            ...
            if (checknull() == false) {
                ...
                jQuery_general.ajax({
                    url: "/ashx/article.ashx?method=umeditorsave",
                    dataType: "json",
        ...
        <div class="formbody">
            <div id="usual1" class="usual">
                ...
                <div id="tab2" class="tabson">
                    <ul>
                        <li>
                            <script type="text/plain" id="myEditor" style="width: 1024px; height: 540px;"></script>
