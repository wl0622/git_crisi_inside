<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="articleueditor.aspx.cs" Inherits="admin.web.aspx.articleueditor" %>
        ...
        <div class="formbody">
            <div id="usual1" class="usual">
                ...
                <div id="tab2" class="tabson">
                    <ul>
                        <li>
                            <script id="ueditor" name="ueditorValue" type="text/plain" style="width: 1024px; height: 500px;">
                            </script>
                            <script type="text/javascript">var ue = UE.getEditor('ueditor');</script>
                        </li>
                    </ul>
                </div>
            </div>
