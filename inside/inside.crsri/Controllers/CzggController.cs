...
{
    public class CzggController : Controller
    {
        //
        // GET: /Czgg/
        ...
        {
            List<requestHomeArticleClass> article = czggDal.requestList();
            return View(article);
        }
        ...
        public ActionResult show(string ID)
        {
            ...
            List<t_web_special_model> specialItems = czggDal.requestDjzcItems().FindAll(a => a.specialID == model.specialID);
