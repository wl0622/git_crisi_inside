...
{
    public class DjzcController : Controller
    {
        //
        // GET: /Djzc/
        ...
        public ActionResult Index()
        {
            ...
            List<requestHomeArticleClass> article = DjzcDal.requestList();
            ViewBag.picxw = DjzcDal.requestPicXW();//图片新闻
            return View(article);
        }
        ...
        {
            ViewBag.djzcItems = DjzcDal.requestDjzcItems();
